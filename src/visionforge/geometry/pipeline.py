...
def main():
    ...
    parser.add_argument("--voxel-size", type=float, default=0.05, help="Voxel downsampling size")
    parser.add_argument("--plane-distance-threshold", type=float, default=0.05, help="RANSAC distance threshold")
    ...
    try:
        pcd_clean, pc_stats = process_point_cloud(
            input_path, output_dir, voxel_size=args.voxel_size
        )
    ...
    print(f"Found {len(planes)} dominant planes.")
